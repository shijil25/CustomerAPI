...
var CustomerOrdersController = /** @class */ (function () {
     ...
     * @param res
     */
    CustomerOrdersController.prototype.getOrders = function (req, res) {
     ...
     * @param res
     */
    CustomerOrdersController.prototype.getOrder = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var order, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        inversify_express_utils_1.httpGet('/orders/:id'),
        __param(0, inversify_express_utils_1.request()), __param(1, inversify_express_utils_1.response()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", Promise)
